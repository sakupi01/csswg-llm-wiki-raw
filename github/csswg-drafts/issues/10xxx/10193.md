...
state: "open"
labels: ["Agenda+", "Closed Accepted by CSSWG Resolution", "Needs Testcase (WPT)", "css-text-4", "i18n-needs-resolution"]
author: "jfkthame"
...
<!-- comment id=5268864936 author=frivoal created=2026-08-12T15:26:17Z url=https://github.com/w3c/csswg-drafts/issues/10193#issuecomment-5268864936 -->
## @frivoal — 2026-08-12

> The i18n WG decided to move this to 'needs-resolution'.

We have a resolution, and the edits have just landed. What remains to do is to check compatibility, as discussed above. Idealy, we will not need to introduce an optional keyword to switch between the legacy bad behavior and the sensible one. But this needs investigation. It'd be great if one or more browser vendor were willing to take the lead here, and trial an implementation to see if anything breaks badly.
