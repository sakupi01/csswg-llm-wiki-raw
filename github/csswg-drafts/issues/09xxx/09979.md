...
state: "open"
labels: ["Closed Accepted by Editor Discretion", "Needs Testcase (WPT)", "css-text-4", "i18n-klreq", "i18n-needs-resolution"]
author: "xfq"
...
<!-- comment id=5283703713 author=fantasai created=2026-08-13T16:47:15Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5283703713 -->
## @fantasai — 2026-08-13

Updated the CSS spec to exclude Wide characters as well as Fullwidth characters from "non-ideographic letters". I'm pretty sure this was an oversight, so marking Editor Discretion.

There's still the issue of fixing UTR#59, however. See [xfq's comment](https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-4675946406).

<!-- comment id=5294553842 author=frivoal created=2026-08-14T14:37:27Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5294553842 -->
## @frivoal — 2026-08-14

Since https://github.com/w3c/csswg-drafts/commit/067ad409711bbe6dde4f401dd0b152cd766cbbf3, css-text no longer cause spacing between Hangul and Latin letters or numerals, nor between Hangul and ideographs. Hangul is neither classified as ideographs nor as non-ideographic letters, so it will not be auto-spaced away from either.

Now, we may still want to give up on classifying characters ourselves for the purpose of autospacing, and lean on UTR#59 instead, and if we do, https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-4675946406 is relevant, and should indeed be upstreamed. But whether and how to switch to UTR59-based logic is a separate issue: https://github.com/w3c/csswg-drafts/issues/11013.

So *this* issue can be considered resolved (though we need to make sure we have corresponding tests).

<!-- comment id=5294591491 author=tats-u created=2026-08-14T14:40:42Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5294591491 -->
## @tats-u — 2026-08-14

Does https://github.com/w3c/csswg-drafts/commit/067ad409711bbe6dde4f401dd0b152cd766cbbf3 resolve https://github.com/w3c/csswg-drafts/issues/9980, too?

<!-- comment id=5294650377 author=frivoal created=2026-08-14T14:46:24Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5294650377 -->
## @frivoal — 2026-08-14

Given that https://www.unicode.org/Public/UCD/latest/ucd/EastAsianWidth.txt classifies Bopomofo as Wide, yes, I believe this solves it too.

<!-- comment id=5299572442 author=YexuanXiao created=2026-08-15T00:41:36Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5299572442 -->
## @YexuanXiao — 2026-08-15

Hello everyone, I think there is another issue with the current spec. According to the current spec, no extra spacing is inserted between math symbols (such as + and -) and Chinese characters, but in my opinion, it should be added.

<!-- comment id=5299607699 author=tats-u created=2026-08-15T00:48:55Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5299607699 -->
## @tats-u — 2026-08-15

https://github.com/w3c/csswg-drafts/issues/9479

<!-- comment id=5302828582 author=hyojinLGE created=2026-08-15T15:07:42Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5302828582 -->
## @hyojinLGE — 2026-08-15

> if a 'word' is composed of some Latin text with a suffix using Hanja, then we'd need to specify that the language should be used as a prompt to indicate that Han characters (ie. Hanja) in Korean should not produce autospacing.

In Korean text, the autospace generally isn't expected in any context including the Latin text with a suffix using Hanja.
https://www.donga.com/archive/newslibrary/view?ymd=19780427 (KAL機, F15機 with no spacing between Latin and Hanja)

> With lang="ko", I think no autospace should be needed, including Hangul and Hanja. Natural spaces should be sufficient.

+1. From a user agent implementation standpoint, I see no problem at all with always applying `text-autospace: no-autospace` implicitly whenever lang="ko" is in effect.

Feel free to ping me if a review would be helpful while incorporating this into https://www.unicode.org/reports/tr59/. Thank you sincerely for the careful consideration given to Hangul!

<!-- comment id=5324822945 author=xfq created=2026-08-18T07:09:53Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5324822945 -->
## @xfq — 2026-08-18

> > if a 'word' is composed of some Latin text with a suffix using Hanja, then we'd need to specify that the language should be used as a prompt to indicate that Han characters (ie. Hanja) in Korean should not produce autospacing.
> 
> In Korean text, the autospace generally isn't expected in any context including the Latin text with a suffix using Hanja. https://www.donga.com/archive/newslibrary/view?ymd=19780427 (KAL機, F15機 with no spacing between Latin and Hanja)

It looks like there is extra spacing around the "5" in the “華國鋒5月初” part of the newspaper?

<!-- comment id=5325567452 author=anawhj created=2026-08-18T08:23:22Z url=https://github.com/w3c/csswg-drafts/issues/9979#issuecomment-5325567452 -->
## @anawhj — 2026-08-18

That is likely an artifact of newspaper typesetting conventions, or the result of some other issue. In recent Korean-focused editing environments, I've confirmed that this autospacing does not occur. The references below may also be worth looking at.
https://gongu.copyright.or.kr/gongu/wrt/wrt/view.do?menuNo=200019&wrtSn=11258770
