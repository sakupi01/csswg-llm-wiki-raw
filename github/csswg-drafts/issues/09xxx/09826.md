...
<!-- comment id=5635508023 author=argyleink created=2026-09-11T13:58:08Z url=https://github.com/w3c/csswg-drafts/issues/9826#issuecomment-5635508023 -->
## @argyleink — 2026-09-11

here to share that Shopify is looking to make scrollbar tracks transparent while maintaining the system thumb color and are currently unable to do so. 

we'd either like to see: 
1. split out properties like `scrollbar-color-thumb` and `scrollbar-color-track` so we can simply specify one like `scrollbar-color-track: #0000`
2. or the ability specify `auto` like `scrollbar-color: auto #0000`
