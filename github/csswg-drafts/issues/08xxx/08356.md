...
<!-- comment id=5277664908 author=byung-woo created=2026-08-13T08:01:10Z url=https://github.com/w3c/csswg-drafts/issues/8356#issuecomment-5277664908 -->
## @byung-woo — 2026-08-13

> Neither actually - we need to preserve even things that fail to be a `complex-real-selector` at all (currently those will return failure). So I'll have to write something a little differently.

@tabatkins, Chrome now supports this behavior behind an experimental flag (m153), and the WPT tests now cover the unclear cases raised above, so it seems the spec is ready to be edited. Is there anything else you'd still like to clarify before editing?
