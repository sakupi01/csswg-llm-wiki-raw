...
<!-- comment id=5297065248 author=Psychpsyo created=2026-08-14T18:58:17Z url=https://github.com/w3c/csswg-drafts/issues/6383#issuecomment-5297065248 -->
## @Psychpsyo — 2026-08-14

The resolution here doesn't specify if `overflow` and `clip` are expected to follow the same rules also. I'd assume they are, but it'd be nice to have that clarified.
