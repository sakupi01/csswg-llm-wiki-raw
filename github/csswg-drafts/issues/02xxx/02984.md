...
<!-- comment id=5204948991 author=SebastianZ created=2026-08-06T13:00:21Z url=https://github.com/w3c/csswg-drafts/issues/2984#issuecomment-5204948991 -->
## @SebastianZ — 2026-08-06

> The major use case presented for this is namespacing of _class_ and _ID_ names. If done with a hyphen (not camel-case), this is covered by [#10001](https://github.com/w3c/csswg-drafts/issues/10001), where the suggestion is to relax existing `|=` matching.

Relaxing `|=` was _one_ of the proposals to tackle prefixes. The initial one was to introduce wildcard selectors, which we just resolved on. I'll file a separate one for relaxing `|=`.
