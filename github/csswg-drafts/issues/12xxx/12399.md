...
<!-- comment id=5540810852 author=ydaniv created=2026-09-04T13:02:17Z url=https://github.com/w3c/csswg-drafts/issues/12399#issuecomment-5540810852 -->
## @ydaniv — 2026-09-04

@estelle in [here](https://github.com/w3c/csswg-drafts/issues/12652#issuecomment-3329841437) we resolved:

> syntax of animation-trigger is `[<dashed-ident> <behavior/actions>]+#`

So the declarative syntax currently allows multiple triggers per animation in `animation-trigger`, but via the imperative API it's currently not allowed.
