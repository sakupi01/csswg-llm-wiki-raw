---
number: 14160
title: "[css-image-animation] FAST checklist"
state: "closed"
labels: []
author: "frivoal"
created_at: "2026-07-10T08:05:09Z"
closed_at: "2026-07-10T08:06:36Z"
url: "https://github.com/w3c/csswg-drafts/issues/14160"
comments: 0
...
- [X] Time-based visual media checklist
 ...
 <summary>More details: Time-based visual media checklist  </summary>
  ...
  - [x] User can pause, stop, replay media.
  ...
  - [x] Users can send output to alternate device.
...
- [X] Content fallback mechanisms checklist

 <details open>

 <summary>More details: Content fallback mechanisms checklist  </summary>

  - [x] Authors can explicitly mark content as not needing alternative content because it does not perform an important role.
  ...
  - [x] Content can explicitly indicate when author declined to provide alternative content.
  ...
  - [x] Content can explicitly indicate that authoring tool is unable to generate or obtain alternative content.
  ...
  - [x] Authors can explicitly associate alternative content with the primary content.
  ...
  - [x] Authors can associate multiple types and instances of alternative content with primary content.
  ...
  - [x] Alternate content can be easily found from the initial content.
