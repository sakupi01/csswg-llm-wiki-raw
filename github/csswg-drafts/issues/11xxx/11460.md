...
<!-- comment id=5278327110 author=jakearchibald created=2026-08-13T09:09:54Z url=https://github.com/w3c/csswg-drafts/issues/11460#issuecomment-5278327110 -->
## @jakearchibald — 2026-08-13

Is this still going to happen?

Context: BCD currently [marks `alphabetic` etc as "not supported" in Chrome and Safari](https://caniuse.com/mdn-css_properties_text-box-edge_alphabetic), which seems wrong to me, but it's being done based on this resolution. [I personally think BCD is wrong to do this](https://github.com/mdn/browser-compat-data/pull/30221#discussion_r3773973108) based on a resolution that hasn't made it into a spec & tests.
