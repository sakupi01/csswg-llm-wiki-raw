...
- Starting with the element itself, it checks `background-color` walking up the parent chain (skipping `display: contents`) until it finds a non-`transparent` value.
