...
<!-- comment id=5350008372 author=Psychpsyo created=2026-08-20T01:20:53Z url=https://github.com/w3c/csswg-drafts/issues/3102#issuecomment-5350008372 -->
## @Psychpsyo — 2026-08-20

Could also use something involving the word isolation/isolated, given that there's there's the [isolation](https://drafts.csswg.org/compositing/#isolation) property, which is a bespoke property that pretty much just means "create stacking context".

Could say that the element "becomes isolated" or is an "isolation container" or somesuch.

Although that might be a bit too SVG for CSS.
