...
In theory, browsers could expose those pseudo-internal properties from the second use case in special stylesheets to implement arbitrary document languages or at least XML dialects. This would probably require some other changes and additions as well, though, e.g. URLs in `attr()`.
