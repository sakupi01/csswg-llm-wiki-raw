...
state: "closed"
labels: ["Closed Accepted by CSSWG Resolution", "Needs Testcase (WPT)", "css-mixins-2"]
author: "LeaVerou"
created_at: "2026-03-25T18:41:44Z"
closed_at: "2026-08-21T21:07:52Z"
...
<!-- comment id=5189648371 author=kbabbitt created=2026-08-05T08:49:14Z url=https://github.com/w3c/csswg-drafts/issues/13727#issuecomment-5189648371 -->
## @kbabbitt — 2026-08-05

> * Adopt the ideas in [[css-variables][css-mixins] In-place hygienic rewriting? #14004](https://github.com/w3c/csswg-drafts/issues/14004) to introduce an `@locals` rule for hygienic rewriting generally and make that the way to specify locals in mixins;
> * Drop `@result` and instead treat the entire mixin body as the result (see also [[css-mixins-1] Auto-wrap mixin body in `@result` if omitted? #13524](https://github.com/w3c/csswg-drafts/issues/13524))

We resolved to do these things (with `@locals` renamed to `@private`) and drop `@macro` in https://github.com/w3c/csswg-drafts/issues/14243#issuecomment-5180782117

<!-- comment id=5375431808 author=tabatkins created=2026-08-21T21:07:52Z url=https://github.com/w3c/csswg-drafts/issues/13727#issuecomment-5375431808 -->
