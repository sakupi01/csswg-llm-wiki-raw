...
<!-- comment id=5621669839 author=yisibl created=2026-09-10T16:03:35Z url=https://github.com/w3c/csswg-drafts/issues/13157#issuecomment-5621669839 -->
## @yisibl — 2026-09-10

Hi @svgeesus 

I ran a test in your tools. Why do `hwb(320deg 30% 40%)` and `rgb(153, 77, 128)` show up as “Not equivalent”?
https://apps.colorjs.io/equivalent-colors/?a=hwb(320deg%2030%25%2040%25)&b=rgb(153%2C%2077%2C%20128)

Is this caused by floating-point numbers?
<img width="1276" height="700" alt="Image" src="https://github.com/user-attachments/assets/72bafd3a-a182-4ce8-a26d-469514ae4387" />

<!-- comment id=5621842194 author=svgeesus created=2026-09-10T16:15:53Z url=https://github.com/w3c/csswg-drafts/issues/13157#issuecomment-5621842194 -->
## @svgeesus — 2026-09-10

Not floating point, but rather the limited precision of quantizing to only 8 bits.

- `hwb(320deg 30% 40%)` is [`rgb(60% 30% 50%)`](https://apps.colorjs.io/convert/?color=hwb(320deg%2030%25%2040%25)&precision=6)
- `rgb(153, 77, 128)` is [`rgb(60% 30.1961% 50.1961%)`](https://apps.colorjs.io/convert/?color=rgb(153%2C%2077%2C%20128)&precision=6)

Those component values differ by more than ε, which my tool puts as the same value as the one CSSWG resolved on for `Oklab` comparisons.

I feel that this value should not be left as implementation defined, by the way.

Note that color equivalence, as defined in section 12, is separate from "visually indistinguishable" which is a much looser classification based on Just Noticeable Differencs (ΔE).. 

<!-- comment id=5621856644 author=svgeesus created=2026-09-10T16:16:58Z url=https://github.com/w3c/csswg-drafts/issues/13157#issuecomment-5621856644 -->
## @svgeesus — 2026-09-10

Related:

 - https://github.com/w3c/csswg-drafts/issues/14472
