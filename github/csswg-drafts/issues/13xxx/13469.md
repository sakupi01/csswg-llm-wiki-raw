---
number: 13469
title: "Wide review of Selectors 4"
state: "open"
labels: ["Administrative Tracker", "a11y-tracker", "i18n-tracker", "privacy-tracker", "security-tracker", "selectors-4"]
author: "svgeesus"
created_at: "2026-02-09T14:41:46Z"
closed_at: null
url: "https://github.com/w3c/csswg-drafts/issues/13469"
comments: 10
has_resolution: false
synced_at: "2026-08-06T00:47:06Z"
---

- [x] Accessibility review [requested 9 Feb 2026](https://github.com/w3c/a11y-request/issues/148) and [completed 18 March](https://github.com/w3c/a11y-request/issues/148#issuecomment-4081732560)
- [x] Internationalization review [requested 9 Feb 2026](https://github.com/w3c/i18n-request/issues/295) and [completed 6 July](https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4049376192)
- [x] Privacy review [requested 9 Feb 2026](https://github.com/w3cping/privacy-request/issues/194) and [completed 17 June](https://github.com/w3cping/privacy-request/issues/194#issuecomment-4724642556)
- [x] Security review [requested 9 Feb 2026](https://github.com/w3c/security-request/issues/118) and [completed 4 August](https://github.com/w3c/security-request/issues/118#issuecomment-5177024748)
- [x] TAG review [requested 15 April 2026](https://github.com/w3ctag/design-reviews/issues/1221) and [completed 2 June](https://github.com/w3ctag/design-reviews/issues/1221#issuecomment-4608087057)
([previous TAG review of Selectors 4](https://github.com/w3ctag/design-reviews/issues/219))

<!-- comment id=3872146034 author=svgeesus created=2026-02-09T14:42:27Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-3872146034 -->
## @svgeesus — 2026-02-09
...
- [ ] Objects that don't have an inherent text representation checklist
...
- [ ] If technology provides content directly for end-users checklist
...
<!-- comment id=3872382306 author=svgeesus created=2026-02-09T15:22:42Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-3872382306 -->
## @svgeesus — 2026-02-09

- .. contains any natural language text that will be read by a human (this includes error messages or other UI text, JSON strings, etc, etc), **NO**
- ... allows content authors to produce typographically appealing text, either in its own right, or in association with graphics. **NO**
- ... allows the user to point into text, creates text fragments, concatenates text, allows the user to select or step through text (using a cursor or other methods), etc. **NO**
- ... allows searching or matching of text, including syntax and identifiers **YES**
  - ._. understand the implications of normalisation, case folding, etc_
  -  matching on syntax is what Selectors are for
  - CSS keywords and [pseudo-class](https://www.w3.org/TR/2026/WD-selectors-4-20260122/#pseudo-class) names are [ASCII case-insensitive](https://infra.spec.whatwg.org/#ascii-case-insensitive).
  - All Selectors syntax is [ASCII case-insensitive](https://infra.spec.whatwg.org/#ascii-case-insensitive) (i.e. [a-z] and [A-Z] are equivalent), except for the parts that are not under the control of Selectors: specifically, the case-sensitivity of document language element names, attribute names, and attribute values depends on the document language. [see 3.7. Characters and case sensitivity](https://www.w3.org/TR/2026/WD-selectors-4-20260122/#case-sensitive)
  -  ... sorts text **NO**
  -  ... captures user input **NO**
  - .. deals with time in any way that will be read by humans and/or crosses time zone boundaries **NO**
  - ... allows any character encoding other than UTF-8
    - this is defined for CSS as a whole, but Selectors (which can be used outside of CSS) defers to the host language
  - .. defines markup **NO**
  - ... deals with names, addresses, time & date formats, etc **NO**
  - ... describes a format or data that is likely to need localisation **NO**
  - ... makes any reference to or relies on any cultural norms **NO**

<!-- comment id=3872823451 author=svgeesus created=2026-02-09T16:44:56Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-3872823451 -->
## @svgeesus — 2026-02-09
...
<!-- comment id=4032547243 author=svgeesus created=2026-03-10T15:53:40Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4032547243 -->
## @svgeesus — 2026-03-10

I see [several issues against Selectors 4 in the I18n repo](https://github.com/w3c/i18n-activity/issues?q=is%3Aissue%20state%3Aopen%20label%3As%3Aselectors), but despite some of them being a month old they have not yet raised them here.

<!-- comment id=4049376192 author=svgeesus created=2026-03-12T19:16:52Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4049376192 -->
## @svgeesus — 2026-03-12

I18n issues to date **all closed** 

 - https://github.com/w3c/csswg-drafts/issues/13644
 - https://github.com/w3c/csswg-drafts/issues/13647
 - https://github.com/w3c/csswg-drafts/issues/13645
 - https://github.com/w3c/csswg-drafts/issues/13646
 - https://github.com/w3c/csswg-drafts/issues/3022
 - https://github.com/w3c/csswg-drafts/issues/3754

Deferred to Selectors 5, may need a new or revised RFC etc

 - https://github.com/w3c/csswg-drafts/issues/8720

<!-- comment id=4253314773 author=svgeesus created=2026-04-15T15:23:51Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4253314773 -->
## @svgeesus — 2026-04-15

The [explainer](https://github.com/w3c/csswg-drafts/blob/main/selectors-4/Selectors_4_Explainer.md) is now complete

<!-- comment id=4614205604 author=svgeesus created=2026-06-03T15:46:23Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4614205604 -->
## @svgeesus — 2026-06-03

General [privacy issue for the interaction between selectors and user state](https://github.com/w3cping/privacy-request/issues/194#issuecomment-4609612953) should be discussed by CSSWG

<!-- comment id=4878566985 author=svgeesus created=2026-07-03T18:17:53Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4878566985 -->
## @svgeesus — 2026-07-03

Despite multiple polite reminders over several months, there has been no response at all to the [request for security review](https://github.com/w3c/security-request/issues/118)

<!-- comment id=4892602729 author=svgeesus created=2026-07-06T12:09:30Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4892602729 -->
## @svgeesus — 2026-07-06

All [I18n issues](https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-4049376192) now resolved, I18n review closed 6 July.

<!-- comment id=5177055343 author=svgeesus created=2026-08-04T09:21:19Z url=https://github.com/w3c/csswg-drafts/issues/13469#issuecomment-5177055343 -->
## @svgeesus — 2026-08-04

One security issue raised

 - https://github.com/w3c/csswg-drafts/issues/14262
